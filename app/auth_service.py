...
class AuthService:
    ...
    async def register_user(self, user_data: UserRegistration) -> Dict[str, Any]:
        ...
        try:
            # ✅ LOG 1: See the complete data object as soon as it enters the function.
            print(f"[BACKEND LOG 1] Data received in auth_service: {user_data.model_dump_json(indent=2)}")
